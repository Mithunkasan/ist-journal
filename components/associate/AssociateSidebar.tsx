...
const menuItems = [
  { textKey: "sb.overview", icon: <Dashboard />, href: "/associate-editor/dashboard" },
  { textKey: "sb.track", icon: <GroupWork />, href: "/associate-editor/dashboard/track" },
  { textKey: "sb.coordination", icon: <RateReview />, href: "/associate-editor/dashboard/coordination" },
  { textKey: "sb.assigned", icon: <Assignment />, href: "/associate-editor/dashboard/submissions" },
  { textKey: "sb.settings", icon: <Settings />, href: "/associate-editor/dashboard/settings" },
];
...
const AssociateSidebar = ({ open, onClose }: AssociateSidebarProps) => (

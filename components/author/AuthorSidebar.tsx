...
const menuItems = [
  { textKey: "sb.overview", icon: <Dashboard />, href: "/author" },
  { textKey: "sb.mysubmissions", icon: <ListAlt />, href: "/author/submissions" },
  { textKey: "sb.submitnew", icon: <CloudUpload />, href: "/author/submit" },
  { textKey: "sb.published", icon: <LibraryBooks />, href: "/author/published" },
  { textKey: "sb.accsettings", icon: <Settings />, href: "/author/settings" },
];
...
const AuthorSidebar = ({ open, onClose }: AuthorSidebarProps) => (

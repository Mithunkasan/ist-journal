    ...
    <Container sx={{ marginBlock: "30px" }}>
      ...
      <Box sx={{ width: "100%" }}>
        <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
          ...
          >
            <Tab label={t("articles.latest")} {...a11yProps(0)} />
            <Tab label={t("articles.inpress")} {...a11yProps(1)} />
            <Tab label={t("articles.cited")} {...a11yProps(2)} />
            <Tab label={t("articles.download")} {...a11yProps(3)} />
            <Tab label={t("articles.popular")} {...a11yProps(4)} />
          </Tabs>
        </Box>
        ...
        <CustomTabPanel value={value} index={4}>
          {lang === "en" ? "Most Popular Articles..." : "المقالات الأكثر شعبية..."}
        </CustomTabPanel>
      </Box>
    </Container>
  );

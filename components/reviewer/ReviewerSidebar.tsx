...
const menuItems = [
  { textKey: "sb.overview", icon: <Dashboard />, href: "/reviewer" },
  { textKey: "sb.myassignments", icon: <Assignment />, href: "/reviewer/assignments" },
  { textKey: "sb.submitreview", icon: <RateReview />, href: "/reviewer/submit" },
  { textKey: "sb.history", icon: <History />, href: "/reviewer/history" },
  { textKey: "sb.myprofile", icon: <Person />, href: "/reviewer/profile" },
];
...
const ReviewerSidebar = ({ open, onClose }: ReviewerSidebarProps) => (

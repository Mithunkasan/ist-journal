...
const menuItems = [
  { textKey: "sb.overview", icon: <Dashboard />, href: "/editor" },
  { textKey: "sb.allsubmissions", icon: <LibraryBooks />, href: "/editor/submissions" },
          ...
          return (
            <ListItem key={item.textKey} disablePadding sx={{ mb: 1 }}>
              ...
              >
                ...
                <ListItemText
                    primary={item.textKey.startsWith("sb.") ? t(item.textKey) : item.textKey}
...
const EditorSidebar = ({ open, onClose }: EditorSidebarProps) => (

...
const translations: Record<string, string> = {
  ...
  "nav.editor": "Chief Editor Dashboard", "nav.editor.ar": "لوحة رئيس التحرير",
  ...
  "sb.editormenu": "Chief Editor Menu", "sb.editormenu.ar": "قائمة رئيس التحرير",
  ...
  "sb.reviewers": "Reviewers", "sb.reviewers.ar": "المراجعين",
  "sb.subeditors": "Associate Editors", "sb.subeditors.ar": "المحررين المساعدين (Associate)",
  "sb.guesteditors": "Guest Editors", "sb.guesteditors.ar": "المحررين الضيوف",
  ...
  "sb.userroles": "User Roles", "sb.userroles.ar": "أدوار المستخدمين",
  "role.admin": "Admin", "role.admin.ar": "مسؤول",
  "role.editor": "Chief Editor", "role.editor.ar": "رئيس التحرير",
  "role.reviewer": "Reviewer", "role.reviewer.ar": "مراجع",
  "role.user": "User", "role.user.ar": "مستخدم",
  "sb.submissiontracking": "Submission Tracking", "sb.submissiontracking.ar": "متابعة التقديمات",
  "sb.editorialmanagement": "Editorial Management", "sb.editorialmanagement.ar": "إدارة التحرير",
  "sb.registereditor": "Register Editor", "sb.registereditor.ar": "تسجيل محرر",
  "sb.registerreviewer": "Register Reviewer", "sb.registerreviewer.ar": "تسجيل مراجع",
